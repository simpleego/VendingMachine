	...
	<div id="content">
		...
		<form action="vm" method="post">
			<table>
				...
				<tr>
					<td class="btn"><input type="submit" ${empty btnMilk?'disabled':'' } value="밀크커피" /> </td>
					<td class="btn"><input type="submit" ${empty btnCream?'disabled':''} value="프림커피" /> </td>
					<td class="btn"><input type="submit" ${empty btnSugar?'disabled':'' } value="설탕커피" /> </td>
					<td class="btn"><input type="submit" ${empty btnBlack?'disabled':'' } value="블랙커피" /> </td>
				</tr>
